...
#include "../../character_design/feature.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_feature_t, stringdata) + ofs \
...
const QMetaObject feature::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_feature.data,
      qt_meta_data_feature,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_feature.stringdata))
